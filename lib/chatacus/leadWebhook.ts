 ...
 * INSTEAD OF sendLeadEmail() — never alongside it. Mirrors Vaughan's and
 * Bloom's lib/chatacus/leadWebhook.ts exactly, with templateId: 'sunnyjim'.
 *
 * If CHATACUS_WEBHOOK_URL isn't configured, this deliberately does NOT
 * fall back to SolarDesk's own Resend notification — the intended
