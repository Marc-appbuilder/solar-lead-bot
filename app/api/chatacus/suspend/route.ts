 ...
 * to 'inactive' (enforced by app/api/chat/route.ts). Mirrors Vaughan's
 * and Bloom's app/api/chatacus/suspend/route.ts exactly.
 *
 ...
 * a write to a hand-configured client like 'solar-demo' or 'landing-demo'.
 */
